...
export const TodoList: React.FC<TodoListType> = ({
  ...
  return (
    <div className="w-full flex flex-col items-start justify-center p-4 bg-gray-100">
      {todos.length === 0 ? (
        <div className="flex justify-between items-center w-full mb-2 p-2 bg-white rounded shadow">
          <div className="flex justify-evenly items-center ">
            <MdOutlineCheckBoxOutlineBlank className="mr-4 cursor-pointer text-blue-500" />
            add your todo!
          </div>
          <button>x</button>
        </div>
          ...
          >
            <div className="flex justify-evenly items-center ">
              {todo.completed === false ? (
                ...
                <>
                  <MdOutlineCheckBox className="mr-4 cursor-pointer text-blue-500" />
            ...
            <button
              ...
              className="mr-2 flex items-center justify-center opacity-0 hover:opacity-100 hover:text-red-500 transition duration-200"
            >
              x
            </button>
          </div>
